...
//                 <p className={styles.productPrice}>₹{item.new_price} <span>₹{item.old_price}</span></p>
//               </div>
//             </div>
//           ))}
//         </div>
...
//   const [loading, setLoading] = useState(true); // For the loader
...
//   // Fetch products based on selected category and price
//   useEffect(() => {
...
//               if (maxPrice) return productPrice >= minPrice && productPrice <= maxPrice;
...
//   // Handle category change and update URL path
