...
// 				`/api/get-all-products-by-category/6637a3e5b72188936f74edff`,
// 				"GET"
// 			)
...
// 	return (
// 		<div className="a_featured_products">
// 			{" "}
// 			{showPopup && (
...
// 				</div>
// 			)}
// 			<div className="a_Our_collection_main_div  bestSaller_main">
// 				{/* Main Heading */}
// 				<div className="a_Main_Home_heading text-center">
...
// 								>
// 									<div className="a_main_our_collection_swiper_options">
// 										<img
// 											src={product.image[1]}
// 											alt={`ImageNumber ${index + 1}`}
// 											className="a_Best_saller_slider_images"
// 										/>
// 										<div className="a_bestSaller_details">
// 											<div className="a_bestSaller_details_content">
